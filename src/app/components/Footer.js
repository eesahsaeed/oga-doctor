...
export function Footer() {
  return (
    <footer className="mt-10 bg-gray-900 px-8 pt-12 pb-8">
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-center gap-12 md:justify-between">
          <div className="text-center md:text-left max-w-md">
            ...
            <Typography color="white" className="mb-8 font-normal leading-relaxed">
              Your on-the-go virtual doctor - certified medical consultations, prescriptions, and health advice, anytime, anywhere in Nigeria. No queues, no stress.
            </Typography>
          ...
          <div className="mt-8 w-full md:mt-0 md:w-auto text-center md:text-left">
            ...
            <div className="flex flex-col gap-3">
              <Button
                ...
                onClick={() => window.open("https://apps.apple.com/ng/app/ogadoctor", "_blank")}
              >
                <img
              ...
              <Button
                ...
                size="lg"
                className="flex items-center justify-center gap-3 normal-case shadow-md hover:shadow-lg transition-all"
                onClick={() => window.open("https://play.google.com/store/apps/details?id=com.ogadoctor.app", "_blank")}
              >
                <img
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-y-6 gap-x-8 border-t border-gray-700 pt-8 md:justify-between">
          <Typography
            color="white"
            className="text-center font-normal opacity-75"
          >
            (c) {CURRENT_YEAR} OgaDoctor. All rights reserved. Made with care in Nigeria.
          </Typography>
