...
export function Testimonials() {
  return (
    <section className="px-6 py-20 md:px-10 lg:py-24 bg-gray-50">
      <div className="container mx-auto">
        ...
        <div className="mb-16 flex w-full flex-col items-center text-center">
          ...
          <Typography variant="h2" color="blue-gray" className="mb-3 text-4xl md:text-5xl font-bold">
          ...
          >
            Real stories from people across Nigeria who have experienced faster, easier, and more convenient healthcare with OgaDoctor â€” no queues, no stress, just quality care when they need it.
          </Typography>
        </div>

        {/* Testimonials Grid â€“ 1 col mobile, 2 on small, 3 on md+ and lg+ */}
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-8 xl:gap-10">
        ...
        <div className="mt-16 text-center">
          <Typography variant="small" className="text-gray-500">
            Join <span className="font-semibold text-blue-700">12,000+</span> happy users who trust OgaDoctor for their health needs
          </Typography>
        </div>
      </div>
    </section>
